...
<main class="h-screen text-white main-content bg-cover bg-no-repeat">
	<div class="flex flex-col px-5 justify-center relative w-screen logo text-center">
		...
		<h1 class="uppercase font-bold text-white text-4xl xl:text-5xl xl:w-1/3 mx-auto leading-normal ">Welcome to your new Haven.
		</h1>
		<h3 class="text-3xl text-white font-500 xl:text-2xl mt-10 mb-40">Where we celebrate the bounty under the sun together</h3>
		...
		<div class="flex xl:flex-row flex-col md:flex-col w-2/3  m-auto notify-me-form xl:space-x-4 xl:space-y-0 space-y-8 justify-center">
			...
			<img width="28px" class="self-center" src="/Whatsapp.svg" />
			<a style="color:white" class="text-white md:text-sm text-xs self-center" href="https://wa.me/971505044506">+971 50 504 4506</a>
			<svg class="self-center " width="27" height="1" viewBox="0 0 27 1" fill="none" xmlns="http://www.w3.org/2000/svg">
				<line y1="0.5" x2="27" y2="0.5" stroke="white" />
			</svg>
