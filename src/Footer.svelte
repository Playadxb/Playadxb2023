...
<footer class="text-center text-white h-auto bg-light-purple">
    <div class="flex flex-col ">
        <div class="flex flex-row justify-center h-20 space-x-16 py-16 " id="footer-menu">
        ...
        <div class="flex flex-row justify-center h-20 space-x-16 py-10" id="footer-menu">
            <a href="#"><img alt="socialmedia" src="./Youtube.webp" class="h-7"></a>
            <a href="#"><img alt="socialmedia" src="./Instagram.webp" class="h-7"></a>
        ...
        <div class="flex justify-center pt-24 pb-12">
            <img src="./playa_red_logo.webp" alt="Playa Dubai Logo" class="lg:w-80 xl:w-96 justify-center " />
        </div>
